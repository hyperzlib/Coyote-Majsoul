...
export interface HuInfoXueZhanMid {
  seat: number;
  hand_count: number;
  hand: string[];
  ming: string[];
...
export interface ActionHuleXueZhanMid {
  hules: HuInfoXueZhanMid[];
  old_scores: number[];
  delta_scores: number[];
  scores: number[];
  doras: string[];
...
export interface ActionHuleXueZhanEnd {
  hules: HuInfoXueZhanMid[];
  old_scores: number[];
  delta_scores: number[];
  scores: number[];
